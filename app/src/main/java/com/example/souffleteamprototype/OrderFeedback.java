...
public class OrderFeedback extends AppCompatActivity {
    ...
    private void submitFeedback() {
        ...
        if (!feedbackText.isEmpty()) {
            long userId = getCurrentUserId();  // Ensure you have a valid user ID here
    ...
    private long getCurrentUserId() {
        // This method needs to correctly fetch the current user's ID
        return 1;  // This is a placeholder; adjust accordingly
    }
}
